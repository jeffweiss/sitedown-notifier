...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(19, Ics, Line, Tlen+1, 16, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 40 ->
    yystate(19, Ics, Line, Tlen+1, 16, Tlen);
...
yystate(26, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(26, [36|Ics], Line, Tlen, Action, Alen) ->
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(19, Ics, Line, Tlen+1, 1, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 40 ->
    yystate(19, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(22, [10|Ics], Line, Tlen, _, _) ->
    yystate(14, Ics, Line+1, Tlen+1, 14, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(19, [C|Ics], Line, Tlen, Action, Alen) when C >= 40 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [10|Ics], Line, Tlen, _, _) ->
    yystate(12, Ics, Line+1, Tlen+1, 12, Tlen);
